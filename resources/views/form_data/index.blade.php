                        ...
                        <tr class="tbody-row">
                            ...
                            <td>
                                <div>
                                    ...
                                    {{-- <form action="{{ route('formdata.destroy', $registro->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                            ...
                            {{-- <td class="border-br-lg">
                                <a href="{{ route('formdata.edit', $registro->id) }}" class="btn btn-sm btn-warning">Editar</a>
